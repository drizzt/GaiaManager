...
const char *const text_launcher[] = {
	...
	"Puedes ejecutar esta utilidad presionando SELECT+START la próxima vez.",
...
const char *const text_cover_msg[] = {
	...
	"¿Quieres descargar las carátulas necesarias (en /dev_hdd0/" COVERS_DIR ")?\nPodría llevar un tiempo...\nPor favor espere",
...
const char *const text_fix_permission[] = {
	...
	"Do you want to try fixing permissions?",
	"Do you want to try fixing permissions?",
	"¿Quieres intentar arreglar los permisos?",
	"Moechten Sie versuchen die Rechte zu korrigieren?",
...
const char *const text_games_folder[] = {
	"is the new folder for games.",
	"is the new folder for games.",
	"is the new folder for games.",
	"es la nueva carpeta para juegos.",
	"is the new folder for games.",
	"is the new folder for games.",
	"is the new folder for games.",
	"is the new folder for games.",
...
const char *const text_download[] = {
	...
	"Download Covers",
	"Telechar Jaquettes",
	"Descargar caratulas", //"Descargar carátulas",
